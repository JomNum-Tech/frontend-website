        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8">
          ...
          >
            ...
            >
              ...
              <span className="xs:inline">Storage</span>
            </TabsTrigger>
          </TabsList>
          {/* Main Content */}
                    ...
                    <div className="space-y-4">
                      <div className="bg-red-100 border border-red-300 rounded-lg p-4">
                        ...
                        <ul className="text-sm text-red-700 space-y-1">
                          <li>
                            <span aria-hidden="true">•</span> Your account and all associated data will be
                            permanently deleted
                          </li>
                          <li>
                            <span aria-hidden="true">•</span> You will lose access to all your classes and
                            progress
                          </li>
                          <li>
                            <span aria-hidden="true">•</span> This action cannot be reversed or recovered
                          </li>
                          <li>
                            <span aria-hidden="true">•</span> You will be immediately signed out
                          </li>
                        </ul>
                      </div>

                      {/* Avoid hydration error by only rendering AlertDialog on client */}
                      {typeof window !== "undefined" && (
                        ...
                        >
                          <AlertDialogTrigger asChild>
                            <Button
                              variant="destructive"
                              className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-2 rounded-lg shadow transition flex items-center gap-2"
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-gray-600">
                    Personalization and notification settings coming soon.
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
