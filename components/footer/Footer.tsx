                ...
                <div className="container mx-auto px-4 md:px-12">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-10">
                        ...
                        <div>
                            ...
                            <blockquote className="border-l-4 border-blue-400 pl-4 italic text-blue-900 bg-blue-50/80 py-3 pr-3 rounded-lg shadow max-w-xs text-base leading-relaxed">
